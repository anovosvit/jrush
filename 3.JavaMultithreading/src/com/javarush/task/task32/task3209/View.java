...
public class View extends JFrame implements ActionListener {
    ...
    private JTabbedPane tabbedPane = new JTabbedPane(); //панель с 2 кнопками
    private JTextPane htmlTextPane = new JTextPane(); //компонент для визуального редактирования хтмл
